...
# 🎮 Lust Share House — Community Edition

**Standalone Community Edition — offline life simulation, ready to play.**
...
Lust Share House is a story-driven life simulation in which the player moves into a shared house and builds relationships with its residents through daily interactions and branching dialogue. This Community Edition is distributed as a standalone, self-contained package. It runs fully offline, requires no storefront and no additional software, and includes all content in a single installer.

Intended for players who want a self-contained, offline Windows build of the complete game.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4924510/f5122d252ee6410e59ec49a1990e8769dbccaff6/ss_f5122d252ee6410e59ec49a1990e8769dbccaff6.1920x1080.jpg?t=1787788827" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4924510/c27d3389a3c0f5c5a5baf42098fbd285d229be94/ss_c27d3389a3c0f5c5a5baf42098fbd285d229be94.1920x1080.jpg?t=1787788827" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4924510/8a773fc8a8599704e2331345640992155e72f926/ss_8a773fc8a8599704e2331345640992155e72f926.1920x1080.jpg?t=1787788827" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏠 **Share House Setting** — Live alongside multiple residents, each with a personal schedule and storyline.
- 📖 **Branching Narrative** — Dialogue choices shape relationships and lead to multiple endings.
- 🎨 **Hand-Drawn Artwork** — Anime-style character art and event illustrations throughout.
- 💾 **Flexible Saving** — Save and load at any point with multiple save slots.
- 🌐 **Multi-Language Interface** — Interface and text available in several languages.
- 🖥️ **Fully Offline** — No internet connection or storefront required after installation.
- ⚙️ **Lightweight Requirements** — Runs on modest hardware, including integrated graphics.
...
- All available content included in the base package
...
| **RAM** | 2 GB | 4 GB |
| **Graphics** | Integrated graphics with DirectX 9 support | DirectX 11 compatible GPU with 1 GB VRAM |
| **Storage** | 4 GB available space | 4 GB available space (SSD) |
| **Additional** | DirectX 9.0c, keyboard and mouse | DirectX 11, audio output device |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\LustShareHouse\Saved`
